...
export default function AddACrop(props) {
	...
	let [search, changeSearch] = React.useState("");
	let [numberPlanted, setNumberPlanted] = React.useState(0);
	...
	return (
		...
		>
			...
			<div className="ui action input">
				<input
					onChange={(e) => changeSearch({ search: e.target.value })}
					type="text"
					placeholder="Search..."
				/>
				<button
				...
				{searchResults.length > 0
					? searchResults.map((crop, index) => (
							<div key={index}>
								...
								>
									<Label size="big" color="olive" href="#">
										{crop.attributes.name}
									</Label>
									<Button
										onClick={() =>
											AddCrop(crop, numberPlanted)
										}
									>
										Confirm
									</Button>
									...
									<img
										...
										src={
											...
											"/assets/baren_field_square-7e8d9de27d478a05b7f6b54b6c5014900d3e5d06e4c06532672af836d40346f0.jpg"
												? crop.attributes
														.main_image_path
												: MissouriDepAgLogo
										}
