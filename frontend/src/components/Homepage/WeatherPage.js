...
export default function WeatherPage() {
	...
	React.useEffect(() => {
		fetch(
			`${API_address}${localStorage.zip},us&units=imperial&appid=${API_key}`
		)
			.then((res) => res.json())
			.then((weather) => {
				setWeather({
		...
		<div className="weather-page" style={{}}>
			...
			<MediaContextProvider>
				<Media greaterThanOrEqual="ml">
					...
					>
						...
						>
							Today's forecast for {weather.city},{" "}
							{localStorage.zip}{" "}
						</Header>
					</div>
				</Media>
			...
			>
				...
				>
					...
					>
						&emsp;{weather.windSpeed} miles/hour{" "}
					</h1>
					<br /> <br />
					<Label
						style={{
					...
					>
						&emsp;{timeConverter(weather.sunrise)}
					</h1>
					<br /> <br />
					<Label
						style={{
					...
					>
						&emsp;{timeConverter(weather.sunset)}
					</h1>
					<br /> <br />
					<Label
						style={{
					...
					>
						&emsp;{weather.visibility} meters
					</h1>
					<br /> <br />
					<Label
						style={{
					...
					<ul>
						...
						<h2>
							{weather.temperature < 40 ? (
								<li>
									{" "}
									It's getting cold! Put a frost cloth out to
									sheild your crops from the weather
								</li>
							) : null}
						</h2>
						{/* No rain vs rain */}
						<h2>
							{weather.main !== "Rain" ? (
								<li>Don't forget to water!</li>
							) : (
								<li>
									No need to water, the rain will take care of
									it today
								</li>
							)}
						</h2>
						...
						<h2>
							...
							weather.main !== <li>Rain</li> ? (
								<li>
									It's hot today, be sure to water a little
									extra
								</li>
							) : null}
						</h2>
						...
						<h2>
							{weather.windSpeed > 15 ? (
								<li>
									It's getting windy! Consider moving potted
									plants or putting up a wind break
								</li>
							) : null}
						</h2>
					</ul>
